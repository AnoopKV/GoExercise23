...
func (c *userServiceClient) Register(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) Register(context.Context, *User) (*UserResponse, error) {
